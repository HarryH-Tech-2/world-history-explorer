...
const ACCENT_COLORS: [string, string] = [colors.orange500, colors.orange600];
            ...
            <Animated.View entering={FadeIn.duration(500).delay(200)} style={styles.gameContent}>
              ...
              <View style={styles.guessesRow}>
                {Array.from({ length: MAX_GUESSES }).map((_, i) => (
                  <View
                    ...
                    style={[
                      styles.guessDot,
                      i < gameState.guessesUsed && styles.guessDotUsed,
                    ]}
                  />
                ))}
              ...
              <GlassCard style={styles.inputCard}>
                ...
                <View style={styles.inputRow}>
                  <MaterialIcons name="date-range" size={22} color={colors.orange500} />
                  <TextInput
                    value={yearInput}
...
const styles = StyleSheet.create({
  ...
  guessDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: colors.orange200 },
