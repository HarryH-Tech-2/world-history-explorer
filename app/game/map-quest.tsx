...
const ACCENT_COLORS: [string, string] = ['#0891B2', '#0E7490'];
...
export default function MapQuestScreen() {
  ...
  const handleSubmit = () => {
    ...
    submitAnswer(locationInput.trim());
    setLocationInput('');
  };
          ...
          {!gameState.isAnswered ? (
            <Animated.View entering={FadeIn.duration(500).delay(300)} style={styles.gameContent}>
              ...
              <GlassCard style={styles.inputCard}>
                <Text style={styles.promptText}>Where did this event take place?</Text>
                <View style={styles.inputRow}>
                  <MaterialIcons name="location-on" size={22} color={ACCENT_COLORS[0]} />
                  <TextInput
                    value={locationInput}
...
const styles = StyleSheet.create({
  ...
  guessDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#B2EBF2' },
